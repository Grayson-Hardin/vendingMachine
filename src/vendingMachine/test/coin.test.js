...
it("should get the verified coins", () => {
    ...
    expect(actual).toEqual([coinFunctions.quarter, coinFunctions.nickle, coinFunctions.dime, coinFunctions.dollar]);
});
...
it("should count the coins", () => {
    const actual = coinFunctions.countCoins([coinFunctions.quarter, coinFunctions.dollar]);
